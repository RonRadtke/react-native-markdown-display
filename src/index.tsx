...
export {AstRenderer, darkStyles, FitImage, createMarkdownIt, getUniqueID, hasParents, MarkdownIt, MarkdownStream, openUrl, parser, renderRules, removeTextStyleProps, sealIncompleteMarkdown, stringToTokens, defaultStyles as styles, textStyleProps, tokensToAST, underlinePlugin};
...
const MarkdownComponent = React.memo(function MarkdownMemo({children, textcomponent = Text, renderer = null, rules = null, style = null, mergeStyle = true, markdownit = createMarkdownIt(), colorScheme, onCopyCode, onLinkPress, maxTopLevelChildren = null, topLevelMaxExceededItem = <Text key="dotdotdot">...</Text>, allowedImageHandlers = ['data:image/png;base64', 'data:image/gif;base64', 'data:image/jpeg;base64', 'https://', 'http://'], defaultImageHandler = 'https://', debugPrintTree = false}: MarkdownProps) {
...
const Markdown = MarkdownComponent as React.NamedExoticComponent<MarkdownProps> & {displayName?: string};
