...
export type MarkdownData = null | boolean | number | string | MarkdownData[] | {[key: string]: MarkdownData};
export type RenderRuleExtra = MarkdownStyleObject | OnLinkPress | OnCopyCode | string[] | string | null | undefined;
...
export type RenderRules = Record<string, RenderRule | undefined> & {link?: RenderRule; blocklink?: RenderRule; image?: RenderRule; unknown?: RenderRule};
