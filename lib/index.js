...
const AstRenderer_1 = __importDefault(require("./lib/view/AstRenderer"));
exports.AstRenderer = AstRenderer_1.default;
const createMarkdownIt_1 = require("./lib/view/createMarkdownIt");
Object.defineProperty(exports, "createMarkdownIt", { enumerable: true, get: function () { return createMarkdownIt_1.createMarkdownIt; } });
const createRenderer_1 = require("./lib/view/createRenderer");
const underline_1 = require("./lib/view/plugins/underline");
Object.defineProperty(exports, "underlinePlugin", { enumerable: true, get: function () { return underline_1.underlinePlugin; } });
const parser_1 = __importDefault(require("./lib/view/parser"));
exports.parser = parser_1.default;
const renderRules_1 = __importDefault(require("./lib/view/renderRules"));
exports.renderRules = renderRules_1.default;
const styles_1 = require("./lib/view/styles");
Object.defineProperty(exports, "styles", { enumerable: true, get: function () { return styles_1.styles; } });
const textStyleProps_1 = __importDefault(require("./lib/view/data/textStyleProps"));
exports.textStyleProps = textStyleProps_1.default;
const getUniqueID_1 = __importDefault(require("./lib/view/util/getUniqueID"));
exports.getUniqueID = getUniqueID_1.default;
const hasParents_1 = __importDefault(require("./lib/view/util/hasParents"));
exports.hasParents = hasParents_1.default;
const openUrl_1 = __importDefault(require("./lib/view/util/openUrl"));
exports.openUrl = openUrl_1.default;
const removeTextStyleProps_1 = __importDefault(require("./lib/view/util/removeTextStyleProps"));
exports.removeTextStyleProps = removeTextStyleProps_1.default;
const stringToTokens_1 = require("./lib/view/util/stringToTokens");
Object.defineProperty(exports, "stringToTokens", { enumerable: true, get: function () { return stringToTokens_1.stringToTokens; } });
const tokensToAST_1 = __importDefault(require("./lib/view/util/tokensToAST"));
exports.tokensToAST = tokensToAST_1.default;
__exportStar(require("./lib/editor"), exports);
const MarkdownComponent = react_1.default.memo(function MarkdownMemo({ children, textcomponent = react_native_1.Text, renderer = null, rules = null, style = null, mergeStyle = true, markdownit = (0, createMarkdownIt_1.createMarkdownIt)(), onLinkPress, maxTopLevelChildren = null, topLevelMaxExceededItem = <react_native_1.Text key="dotdotdot">...</react_native_1.Text>, allowedImageHandlers = [
