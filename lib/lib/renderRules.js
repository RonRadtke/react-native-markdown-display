...
const renderRules = (Text) => ({
    ...
    link: (node, children, _parent, styles, onLinkPress) => (<react_native_1.Pressable accessibilityLabel={getBlockLinkAccessibilityLabel(node)} accessibilityRole="link" key={node.key} onPress={() => (0, openUrl_1.default)(node.attributes.href, getOnLinkPress(onLinkPress))}>
      <Text style={styles.link}>{children}</Text>
    </react_native_1.Pressable>),
    blocklink: (node, children, _parent, styles, onLinkPress) => (<react_native_1.Pressable accessibilityRole="link" key={node.key} onPress={() => (0, openUrl_1.default)(node.attributes.href, getOnLinkPress(onLinkPress))} style={styles.blocklink}>
